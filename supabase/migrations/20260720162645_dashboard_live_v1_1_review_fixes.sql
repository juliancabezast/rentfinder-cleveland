-- dashboard_live v1.1 review fixes: next_showings strictly future (was now()-1h,
-- which surfaced already-started showings labeled "Hoy" with a past time);
-- drop the dead showings.applicants=0 field (the card reads leads.applicants).
