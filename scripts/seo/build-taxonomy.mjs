...
const config = {
  ...
  phoneDisplay: "(216) 201-9201",
  phoneE164: "+12162019201",
  ...
  llmsSummary:
    "Rent Finder Cleveland is a residential property-management and leasing company in Cleveland, Ohio. We manage 90+ rental homes — every one accepts Section 8 / Housing Choice Vouchers and is HUD-inspection-ready — concentrated on Cleveland's East and Southeast sides. This site helps renters find houses and apartments for rent in Cleveland OH, understand Section 8 vouchers, and book showings.",
  ...
  cta: {
    "book-showing": {
      ...
      blockBody: "Book a free showing with our local leasing team. Every home we manage welcomes Housing Choice Vouchers and is HUD-inspection-ready.",
    },
    contact: {
      href: "/p/book-showing",
      ...
      blockBody: "Tell us what you need and we'll show you what's available now. We manage 90+ voucher-friendly homes across the Cleveland area and add more regularly.",
    },
    apply: {
      href: "/apply",
      label: "Apply Now",
...
const clusters = {
  ...
  "section-8": {
    ...
    heroSub: "Everything Cleveland renters need to know about Housing Choice Vouchers and CMHA — and how to find homes that welcome them. Every home we manage accepts Section 8.",
...
const pillars = [
  {
    ...
    metaDescription: "Houses for rent in Cleveland, OH from a local property manager. 2–3 bedroom homes, ~$700–$1,800/mo, and every home accepts Section 8. Book a free showing.",
  ...
  },
  {
    ...
    metaDescription: "Section 8 housing in Cleveland, OH — how CMHA vouchers work, applying, payment standards, and finding homes that accept them. Every home we manage is voucher-friendly.",
    heroSub: "The complete Cleveland renter's guide to Housing Choice Vouchers — and a property manager whose entire portfolio welcomes them.",
