...
const AGENT_NAMES: Record<string, string> = {
  ...
  samuel: "Jupiter",
  zacchaeus: "Saturn",
  main_inbound: "Mercury",
  hemlane_parser: "Venus",
  scoring: "Neptune",
  transcript_analyst: "Neptune",
  task_dispatcher: "Neptune",
  recapture: "Mars",
  showing_confirmation: "Jupiter",
  conversion_predictor: "Neptune",
  insight_generator: "Neptune",
  report_generator: "Neptune",
  doorloop_pull: "Jupiter",
  cost_tracker: "Saturn",
  no_show_followup: "Jupiter",
  no_show_follow_up: "Jupiter",
  post_showing: "Jupiter",
  campaign: "Mars",
  welcome_sequence: "Mars",
};

// ── Source → agent that brought the lead in ──────────────────────────

const SOURCE_INFO: Record<string, { agent: string; action: string; updateAction: string }> = {
  hemlane_email: { agent: "Venus", action: "registered via Hemlane", updateAction: "updated via Hemlane" },
  website: { agent: "Mercury", action: "captured from website", updateAction: "updated from website" },
  sms: { agent: "System", action: "registered via inbound SMS", updateAction: "updated via SMS" },
  referral: { agent: "Mercury", action: "registered as referral", updateAction: "updated referral" },
  manual: { agent: "—", action: "entered manually", updateAction: "updated manually" },
  campaign: { agent: "Mars", action: "captured in outbound campaign", updateAction: "updated in campaign" },
};
