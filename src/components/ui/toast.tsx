...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "close-btn absolute right-2 top-2 h-7 w-7 flex items-center justify-center rounded-lg text-foreground/40 opacity-0 transition-all group-hover:opacity-100 group-[.destructive]:text-red-300 hover:bg-muted hover:text-foreground group-[.destructive]:hover:bg-red-900/20 group-[.destructive]:hover:text-red-50 focus:opacity-100 focus:outline-none focus:ring-2 group-[.destructive]:focus:ring-red-400 group-[.destructive]:focus:ring-offset-red-600",
      className,
    )}
    toast-close=""
    {...props}
