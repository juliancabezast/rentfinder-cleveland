 ...
 const SOCIAL_PROOF_DATA = [
   { name: "Emily Johnson", address: "1847 Cedar Ave, Cleveland" },
   { name: "Marcus Williams", address: "3921 Denison Ave, Cleveland" },
   { name: "Sarah Mitchell", address: "2156 W 28th St, Cleveland" },
   { name: "David Thompson", address: "4483 Pearl Rd, Cleveland" },
   { name: "Jessica Rivera", address: "1629 Payne Ave, Cleveland" },
   { name: "Michael Chen", address: "2874 Scranton Rd, Cleveland" },
   { name: "Amanda Foster", address: "3347 Fulton Rd, Cleveland" },
   { name: "Robert Garcia", address: "1958 W 25th St, Cleveland" },
   { name: "Lauren Brooks", address: "4216 Lorain Ave, Cleveland" },
   { name: "James Patterson", address: "2743 Bridge Ave, Cleveland" },
   { name: "Nicole Stewart", address: "1482 Literary Rd, Cleveland" },
   { name: "Christopher Davis", address: "3165 Trowbridge Ave, Cleveland" },
 ];
 ...
 const SocialProofToast: React.FC = () => {
   ...
   useEffect(() => {
     ...
     // Subsequent toasts every 8-10 seconds (randomized)
