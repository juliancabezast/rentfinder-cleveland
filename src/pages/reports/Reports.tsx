      ...
      <Card>
        <CardContent className="p-0">
          <EmptyState
            ...
            description="Advanced analytics and reporting features are currently in development. Check back soon for detailed insights into your lead pipeline, conversion rates, and property performance."
          />
        </CardContent>
      </Card>
    </div>
