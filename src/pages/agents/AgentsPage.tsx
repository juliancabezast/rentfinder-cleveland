...
// Biblical name to functional name mapping
const AGENT_DISPLAY_NAMES: Record<string, string> = {
  nehemiah: "Task Dispatcher",
  task_dispatcher: "Task Dispatcher",
  raphael: "Health Checker",
  health_checker: "Health Checker",
  uriel: "Notification Dispatcher",
  notification_dispatcher: "Notification Dispatcher",
  lydia: "Welcome Sequence",
  welcome_sequence: "Welcome Sequence",
  daniel: "Scoring Agent",
  scoring: "Scoring Agent",
  aaron: "Twilio Inbound",
  twilio_inbound: "Twilio Inbound",
  deborah: "Bland Call Handler",
  bland_call: "Bland Call Handler",
  naomi: "Recapture",
  recapture: "Recapture",
  abigail: "Showing Confirmation",
  showing_confirmation: "Showing Confirmation",
  elijah: "No-Show Follow-Up",
  no_show_followup: "No-Show Follow-Up",
  no_show_follow_up: "No-Show Follow-Up",
  priscilla: "Post-Showing",
  post_showing: "Post-Showing",
  phoebe: "SMS Inbound",
  sms_inbound: "SMS Inbound",
  ruth: "Hemlane Parser",
  hemlane_parser: "Hemlane Parser",
  joseph: "Compliance Check",
  compliance_check: "Compliance Check",
  zacchaeus: "Cost Tracker",
  cost_tracker: "Cost Tracker",
  solomon: "Transcript Analyst",
  transcript_analyst: "Transcript Analyst",
  samuel: "Conversion Predictor",
  conversion_predictor: "Conversion Predictor",
  isaiah: "Insight Generator",
  insight_generator: "Insight Generator",
  luke: "Report Generator",
  report_generator: "Report Generator",
  matthew: "Sheets Backup",
  sheets_backup: "Sheets Backup",
  esther: "Doorloop Pull/Push",
  doorloop_pull: "Doorloop Pull",
  doorloop_push: "Doorloop Push",
  rebekah: "Smart Matcher",
  smart_matcher: "Smart Matcher",
  paip: "AI Assistant",
  paip_assistant: "AI Assistant",
};
